...
const Login = (props) => {
    ...
    document.title = "Login | ChitChat React - Responsive Bootstrap 5 Chat App"
                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5} >
                            <div className="text-center mb-4">
                                ...
                                <h4>{t('Sign in')}</h4>
                                <p className="text-muted mb-4">{t('Sign in to continue to ChitChat')}.</p>
