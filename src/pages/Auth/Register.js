...
const Register = (props) => {
    ...
    document.title = "Register | ChitChat React - Responsive Bootstrap 5 Chat App"
                    ...
                    <Row className="justify-content-center">
                        <Col md={8} lg={6} xl={5}>
                            <div className="text-center mb-4">
                                ...
                                <h4>{t('Register')}</h4>
                                <p className="text-muted mb-4">{t('Get your ChitChat account now')}.</p>
                                ...
                                <CardBody className="p-4">
                                    ...
                                    >
                                        ...
                                        <div className="mt-4 text-center">
                                            <p className="text-muted mb-0">{t('By registering you agree to the ChitChat')} <Link to="#" className="text-primary">{t('Terms of Use')}</Link></p>
                                        </div>
                            ...
                            <div className="mt-5 text-center">
                                ...
                                <p>© {new Date().getFullYear()} {t('ChitChat')}. {t('Crafted with')} <i className="mdi mdi-heart text-danger"></i> {t('by CodingMonk')}</p>
                            </div>
                        </Col>
                    </Row>
                </Container>
